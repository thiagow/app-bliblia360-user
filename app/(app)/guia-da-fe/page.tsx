    ...
    <div className="min-h-full">
      <header className="mb-5">
        ...
        <p className="text-sm text-zinc-400 mt-1">
          O Guia da Fé é o seu acompanhamento diário de disciplinas espirituais. Marque cada prática que você realizou no dia através do calendário abaixo e acompanhe o seu crescimento ao longo do mês.
        </p>
      </header>
